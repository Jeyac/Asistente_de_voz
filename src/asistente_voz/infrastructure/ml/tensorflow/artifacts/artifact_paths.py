...
class ArtifactPaths:
    ...
    def from_settings(cls, settings: Settings) -> "ArtifactPaths":
        ...
        return cls(
            ...
            model_file=settings.tensorflow_model_path,
            tokenizer_file=models_dir / settings.tf_tokenizer_filename,
            labels_file=models_dir / settings.tf_labels_filename,
            metadata_file=models_dir / settings.tf_metadata_filename,
        )

...
class HybridIntentPredictor:
    ...
    def __init__(
        self,
        tensorflow_predictor: IntentPredictor,
    ...
    def predict(self, text: str) -> PredictionResult:
        ...
        use_keyword = (
            not tf_result.above_threshold
            or tf_result.intent == self._fallback_intent
            or kw_intent not in tf_result.probabilities
            or tf_result.probabilities.get(kw_intent, 0.0) < 0.05
        )
        ...
        return PredictionResult(
            ...
            raw_text=tf_result.raw_text,
            cleaned_text=tf_result.cleaned_text,

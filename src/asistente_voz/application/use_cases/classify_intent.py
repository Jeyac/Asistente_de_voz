...
class ClassifyIntentUseCase:
    ...
    async def execute(self, text: str) -> PredictionResult:
        ...
        return PredictionResult(intent=raw_result.intent, confidence=raw_result.confidence, raw_text=raw_result.raw_text, cleaned_text=raw_result.cleaned_text, above_threshold=raw_result.above_threshold, probabilities=raw_result.probabilities)

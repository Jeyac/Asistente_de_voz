...
class ActivateAndListenUseCase:
    ...
    def __init__(self, activation_listener: ActivationListenerService, process_voice: ProcessVoiceCommandUseCase) -> None:
    ...
    async def execute(self, wakeword_timeout: float | None=None) -> ActivationListenResult:
        ...
        try:
            ...
            logger.info('Flujo por activación completado | intent=%s', voice_result.intent)

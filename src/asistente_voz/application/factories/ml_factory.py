...
class MlFactory:
    ...
    def create_intents_repository(self):
        """Función create intents repository."""
    ...
    def create_trainer(self):
        ...
        return IntentModelTrainer(settings=self._settings, intents_repository=self.create_intents_repository(), artifact_store=ArtifactStore(self._settings))

    def create_classifier(self):
        """Función create classifier."""
        from asistente_voz.infrastructure.ml.tensorflow.intent_classifier import TensorFlowIntentClassifier
        return TensorFlowIntentClassifier(self._registry.predictor)

    def create_classify_use_case(self) -> ClassifyIntentUseCase:
        """Función create classify use case."""
